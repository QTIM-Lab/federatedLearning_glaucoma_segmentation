...
#SBATCH --job-name=train_fl_new_pipeline_batch8
#SBATCH --gres=gpu:1
#SBATCH --ntasks=16
#SBATCH --output=train_fl_new_pipeline_batch8.%j.out
#SBATCH --error=train_fl_new_pipeline_batch8%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/train_fl_new_pipeline_batch8"
...
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/train_fl_new_pipeline_batch8/models"
LAST_CHECKPOINT=$(ls ${MODEL_DIR}/best_global_model_round_*.pth | sort -V | tail -n 1)

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/train_fl_new_pipeline_batch8"
# test
