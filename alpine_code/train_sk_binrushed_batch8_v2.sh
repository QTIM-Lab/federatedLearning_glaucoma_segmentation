...
#SBATCH --job-name=train_sk_binrushed_batch8_v2
#SBATCH --gres=gpu
#SBATCH --ntasks=16
#SBATCH --output=train_sk_binrushed_batch8_v2.%j.out
#SBATCH --error=train_sk_binrushed_batch8_v2%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/train_sk_binrushed_batch8_v2"
...
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/train_sk_binrushed_batch8_v2/models"
LAST_CHECKPOINT=$(ls ${MODEL_DIR}/model_epoch*_ckpt.pt | sort -V | tail -n 1)

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/train_sk_binrushed_batch8_v2"
# test
python3 /projects/uthakuria@xsede.org/glaucoma_seg_code/run_inference_multiprocess.py \
    --model_path ${LAST_CHECKPOINT} \
    --input_csv /projects/uthakuria@xsede.org/glaucoma_seg_code/csvs/binrushed_test.csv \
