...
#SBATCH --job-name=sk_rimone_batch8
#SBATCH --gres=gpu:1
#SBATCH --ntasks=16
#SBATCH --output=sk_rimone_batch8.%j.out
#SBATCH --error=sk_rimone_batch8%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/sk_rimone_batch8"
...
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/sk_rimone_batch8/models"
LAST_CHECKPOINT=$(ls ${MODEL_DIR}/model_epoch*_ckpt.pt | sort -V | tail -n )

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/sk_rimone_batch8"
# test
