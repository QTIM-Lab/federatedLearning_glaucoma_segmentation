...
def train_one_epoch(model, dataloader, optimizer, criterion, device, accumulation_steps=8):
    model.train()
    total_loss = 0
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        total_loss += loss.item() * accumulation_steps  # Unscale the loss for reporting
    ...
    for fl_round in range(start_fl_round, fl_rounds):
        ...
        for site_index in range(len(train_dataloaders)):
            ...
            for epoch in range(local_sites_training_epochs):
                ...
                train_loss = train_one_epoch(model, train_loader, optimizer, criterion, device, accumulation_steps=8)
