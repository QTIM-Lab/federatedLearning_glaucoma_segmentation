...
#SBATCH --job-name=globalVal_weightedVal_cuda_optimized
#SBATCH --gres=gpu
#SBATCH --ntasks=16
#SBATCH --output=globalVal_weightedVal_cuda_optimized.%j.out
#SBATCH --error=globalVal_weightedVal_cuda_optimized%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/globalVal_weightedVal_cuda_optimized"

echo "Starting training!"

# train
python3 /projects/uthakuria@xsede.org/glaucoma_seg_code/globalVal_weighted_val_alpine_code_cuda_optimized.py \
...
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/globalVal_weightedVal_cuda_optimized/models"
LAST_CHECKPOINT=$(ls ${MODEL_DIR}/best_global_model_epoch*.pth | sort -V | tail -n 1)

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/globalVal_weightedVal_cuda_optimized"
# test
