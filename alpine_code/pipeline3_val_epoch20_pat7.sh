...
#SBATCH --job-name=pipeline3_val_epoch20_pat7
#SBATCH --gres=gpu:1
#SBATCH --ntasks=16
#SBATCH --output=pipeline3_val_epoch20_pat7.%j.out
#SBATCH --error=pipeline3_val_epoch20_pat7%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/pipeline3_val_epoch20_pat7"

# echo "Starting training!"

# # train
# python3 /projects/uthakuria@xsede.org/glaucoma_seg_code/alpine_code_fl_pipeline_2_cudaOptimized.py \
...
#     --num_workers 16 \
#     --local_sites_training_epochs 10 \
#     --fl_patience 10 
...
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/pipeline3_val_epoch20_pat7/models"
LAST_CHECKPOINT="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/train_fl_pipeline3_weightedVal_pat7_epochs20/models/best_global_model_round_2_metric_0.3368.pth"

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/pipeline3_val_epoch20_pat7"
# test
