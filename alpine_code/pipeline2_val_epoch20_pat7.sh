...
#SBATCH --job-name=pipeline2_val_epoch20_pat7
#SBATCH --gres=gpu:1
#SBATCH --ntasks=16
#SBATCH --output=pipeline2_val_epoch20_pat7.%j.out
#SBATCH --error=pipeline2_val_epoch20_pat7%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/pipeline2_val_epoch20_pat7"
...
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/pipeline2_val_epoch20_pat7/models"
LAST_CHECKPOINT="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/train_fl_new_pipeline_batch8/models/best_global_model_round_7_metric_3.0092.pth"

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/pipeline2_val_epoch20_pat7"
# test
