...
#SBATCH --job-name=train_fl_batch8_v2_all9
#SBATCH --gres=gpu
#SBATCH --ntasks=8
#SBATCH --output=train_fl_batch8_v2_all9.%j.out
#SBATCH --error=train_fl_batch8_v2_all9%.err
...
OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/train_outputs/train_fl_batch8_v2_all9"
MODEL_DIR="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/train_fl_batch8_v2_all9/models"
LAST_CHECKPOINT="/scratch/alpine/uthakuria@xsede.org/fl_glaucoma_checkpoints/train_fl_batch8_v2_all9/models/best_global_model_epoch47.pth"

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/projects/uthakuria@xsede.org/glaucoma_seg_code/test_outputs/train_fl_batch8_v2_all9"
# test
