...
python3 ../../fl_train_glaucoma_seg.py \
    --train_csv /sddata/data/retina_datasets_preprocessed/output_csvs/rimone_train.csv \
    --val_csv /sddata/data/retina_datasets_preprocessed/output_csvs/rimone_val.csv \
    --csv_img_path_col image_path \
    --csv_label_path_col label_path \
    --output_directory /home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/train_outputs/train_outputs_rimone_v2 \
