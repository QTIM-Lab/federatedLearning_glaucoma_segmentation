...
combined_mean="0.76759907 0.47504155 0.28852546"
combined_std="0.21993166 0.19735417 0.16538888"
...
python3 ../../fl_train_glaucoma_seg.py \
    ...
    --output_directory /home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/train_outputs/train_outputs_drishti_v2 \
