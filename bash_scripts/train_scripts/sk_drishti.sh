...
OUTPUT_DIRECTORY="/home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/train_outputs/sk_drishti"
...
python3 /home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/sk_train_mask2former.py \
    --train_csv /sddata/data/retina_datasets_preprocessed/output_csvs/drishti_train.csv \
    --val_csv /sddata/data/retina_datasets_preprocessed/output_csvs/drishti_val.csv \
...
MODEL_DIR="/sddata/data/retina_datasets_preprocessed/fl_glaucoma_checkpoints/sk_drishti/models"
LAST_CHECKPOINT=$(ls ${MODEL_DIR}/model_epoch*_ckpt.pt | sort -V | tail -n 1)

echo "Using checkpoint: ${LAST_CHECKPOINT}"
echo "Starting testing!"

TEST_OUTPUT_DIRECTORY="/home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/test_outputs/sk_drishti"
# test
