...
python3 ../../fl_train_glaucoma_seg.py \
    ...
    --output_directory /home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/train_outputs/train_outputs_fl_finetune_messidor_v2 \
    --dataset_mean $messidor_mean \
    --dataset_std $messidor_std \
    --lr 0.00003 \
    --batch_size 16 \
    ...
    --num_workers 16 \
    --cuda_num 0 \
    --fl_finetuned /home/thakuriu/fl_glaucoma_seg/detection_segmentation_v2/segmentation_train_and_inference/train_outputs/train_outputs_messidor_v2/model/best_global_model_epoch28.pth
